class AppConfig {
  ...
  AppConfig({
    ...
    this.mainColorHex = "4E4E7B",
    this.accentColorHex = "4E4E7B",
    this.adminPassword,
    ...
    this.galleryPath,
    this.collagePath,
    this.photoIconPath = "assets/images/camera-solid-full.svg",
    this.galleryIconPath = "assets/images/images-solid-full.svg",
    this.collageIconPath = "assets/images/table-cells-large-solid-full.svg",
    this.backIconPath = "assets/images/back.svg",
    this.printIconPath = "assets/images/print-solid-full.svg",
    this.removeIconPath = "assets/images/trash-solid-full.svg",
    this.closeIconPath = "assets/images/xmark-solid-full.svg",
    this.prevIconPath = "assets/images/caret-left-solid-full.svg",
    this.nextIconPath = "assets/images/caret-right-solid-full.svg",
  ...
  factory AppConfig.fromJson(Map<String, dynamic> json) => AppConfig(
        ...
        mainColorHex: json["mainColorHex"] ?? "4E4E7B",
        accentColorHex: json["accentColorHex"] ?? "4E4E7B",
        ...
        photoIconPath: json["photoIconPath"] ?? "assets/images/camera-solid-full.svg",
        galleryIconPath: json["galleryIconPath"] ?? "assets/images/images-solid-full.svg",
        collageIconPath: json["collageIconPath"] ?? "assets/images/table-cells-large-solid-full.svg",
        backIconPath: json["backIconPath"] ?? "assets/images/back.svg",
        printIconPath: json["printIconPath"] ?? "assets/images/print-solid-full.svg",
        removeIconPath: json["removeIconPath"] ?? "assets/images/trash-solid-full.svg",
        closeIconPath: json["closeIconPath"] ?? "assets/images/xmark-solid-full.svg",
        prevIconPath: json["prevIconPath"] ?? "assets/images/caret-left-solid-full.svg",
        nextIconPath: json["nextIconPath"] ?? "assets/images/caret-right-solid-full.svg",
